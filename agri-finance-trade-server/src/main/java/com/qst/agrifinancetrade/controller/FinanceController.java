...
//        System.out.println(intention);
    ...
    @GetMapping("/selectFinanceUser/{bankId}")
    public Result selectFinanceUser(@PathVariable("bankId") String bankId){
        //获取登陆的用户名
        UserDetails principal = (UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        String name = principal.getUsername();
//        System.out.println("bankId:"+bankId);
        FinanceUserDetails financeUserDetails = financeService.selectFinanceUser(name,bankId);
