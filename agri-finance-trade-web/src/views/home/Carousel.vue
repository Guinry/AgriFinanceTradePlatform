<template>
  <el-carousel class="demonstration" trigger="click" >
    <el-carousel-item>
      <img src="../../assets/FrontPage/CarouselImages/carousel1.jpg" style="height: 100%; width: 100%;" alt=""/>
    ...
    <el-carousel-item >
      <img src="../../assets/FrontPage/CarouselImages/carousel2.jpg" style="height: 100%; width: 100%;" alt=""/>
      <div class="carousel-title2">
        ...
        <div style="margin-left:100px;margin-top:40px;color: #666666;font: 15px 微软雅黑;">TO PROVIDE YOU WITH QUALITY PRODUCTS AND</div>
      </div>
    </el-carousel-item>
  </el-carousel>
</template>
...
.carousel-title2{
  ...
  width: 671px;
  padding-top: 27px;
  background: url("../../assets/FrontPage/fontback2.png");
}
</style>